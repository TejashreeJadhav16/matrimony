...
/* =====================
   SUSPEND ACTION
===================== */
if (isset($_GET['suspend'], $_GET['token'])) {

    if (!hash_equals($_SESSION['csrf_token'], $_GET['token'])) {
        die('Invalid request');
    }

    $userId = (int) $_GET['suspend'];

    // Suspend only approved users
    $stmt = $conn->prepare(
        "UPDATE users 
    ...
    header("Location: /matrimony/admin/user-management/suspend-users.php?success=1");
    exit;
}
...
<div class="admin-layout">
    ...
    <main class="admin-main">
        ...
        <div class="card">
            ...
            <h2>Suspend Users</h2>
            <p class="sub">Temporarily suspend approved users</p>

            <?php if (isset($_GET['success'])): ?>
                <div class="success">⏸ User suspended successfully</div>
            <?php endif; ?>
                    ...
                    <tbody>
                        ...
                        <?php foreach ($users as $u): ?>
                            <tr>
                                ...
                                <td>
                                    <a
                                        href="/matrimony/admin/user-management/suspend-users.php?suspend=<?= $u['id'] ?>&token=<?= $_SESSION['csrf_token'] ?>"
                                        class="btn suspend"
